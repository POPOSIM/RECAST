...
class DB(object):
    ...
    def get_rnd_graph_name(self, seed, time):
        name = "rnd" + self.get_db_name() + "_seed" + str(seed) + "_time" + str(time)
        return name
